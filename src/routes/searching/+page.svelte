<script lang="ts">
    ...
    let textArea: any;
    let searchTerm: any;
    let selectedSearch: any = ["Linear Search", "Binary Search", "Jump Search","Exponential Search"];
...
<h1 class="text-5xl font-bold mb-12 text-center mt-6">Searching Algorithms</h1>

<div class="flex flex-col mx-auto gap-y-8 items-center h-screen justify-center absolute">

    <div  class="flex space-x-2">
        <input type="text" class="p-2 rounded-md border w-96" bind:value={textArea} placeholder="Enter item" />
    ...
    <div class="flex space-x-2">
        ...
        <select class="p-2 rounded-md border" bind:value={selected}>
